...
To test the email confirmation functionality, you can run the project locally from the EmailConfirmation branch. It didn't end up in production because of the Resend limitations.
